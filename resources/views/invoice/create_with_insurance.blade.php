...
@section('scripts')
    ...
    <script>
        $('#discount_insurance_company').on('change', function() {
            ...
            let discount_amount = $("#sell_price").val() * (dict['discount'] / 100);
            $("#sell_price_after_discount").val($("#sell_price").val() - discount_amount);
            $("#discount_reason").val("تأمين من شركة" + " " + dict['name']);
        });
    </script>
    <script>
