            ...
            <div class="row content-panel">
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="invoice-body">
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label"> اسم المريض</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label"> رقم الوطني</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="" disabled>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label"> رقم بطاقة التأمين</label>
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="" disabled>
                            </div>
                        </div>
