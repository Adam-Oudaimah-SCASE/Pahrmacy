...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-left mr"></i>إضافة مخزن  معلومات مخزن الدواء</h3>
                ...
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" action="{{ route('drug.store') }}" method="POST">
                        ...
                        <div class="form-group" dir="rtl">
                            <label class="col-sm-2 col-sm-2 control-label">اختر الدواء</label>
                            <div class="col-sm-4">
                            ...
                            <label class="col-sm-2 col-sm-2 control-label">رقم الوحدة</label>
                            <div class="col-sm-4">
