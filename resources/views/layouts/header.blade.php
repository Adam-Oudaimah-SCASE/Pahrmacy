     ...
     <!-- <img src="" style="width:70px;height:70px;" />-->
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="login.html">تسجيل الخروج</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <ul class="sub">
            <li><a href="/drugs">	عرض الادوية </a></li>
            <li><a href="/category">	الأقسام</a></li>
            <li><a href="/shape">	الاشكال الدوائية </a></li>
        ...
        <li><a href="/company">	الشركات المنتجة 	 </a></li>
      ...
      <ul class="sub">
        <li><a href="/warehouse">	المستودعات الموجودة 	 </a></li>
